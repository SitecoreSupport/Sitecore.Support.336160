                    ...
                    try
                    {
                        ...
                        using (new TrackerSwitcher(new local.Sitecore.Analytics.NullTracker(session)))
                        {
                            ...
                            using (new SessionSwitcher(session))
                            {
                                ...
                                {
                                    typeof(AutomationStateContext).GetProperty("IsDue", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).SetValue(context, true);
